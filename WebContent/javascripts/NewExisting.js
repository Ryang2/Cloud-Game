    ...
    $scope.selectGame = function(gameID) { 
        ...
        var indCloud = {}, indQues = {}, cloudData = [], quesData = []; //TODO
			...
			for(var i = 0; i < quesData.length; i++){
				if(QAArray.indexOf(quesData[i].QAName) == -1){QAArray.push(quesData[i].QAName)} //TODO NEW GAME DOESN'T ORDER!
			}
			console.log(quesData);
			console.log(cloudData);
			console.log(QAArray);
			prepGame(quesData, cloudData); //Or some sort of function that loads in the data TODO sort the questions by whether it's asked or not and filter it
	...
	$('#NQASubmit').click(function() {
		if(QAArray.length == 0){
			...
			var list = [
				...
				prepGame(quesData, null); // Which should load in the questions data! 
